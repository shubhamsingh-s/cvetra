        ...
        <main className="min-h-screen bg-background text-foreground p-6 md:p-12">
            ...
            <div className="max-w-4xl space-y-6">
                ...
                <div className="grid md:grid-cols-2 gap-6">
                    ...
                    <div className="glass rounded-[2rem] p-8 border border-white/10">
                        <CalendarRange className="w-5 h-5 text-green-500 mb-3" />
                        <h2 className="font-semibold mb-2">Interview planning</h2>
                        <p className="text-sm text-muted-foreground">Use this area for interview scheduling and status updates.</p>
                    </div>
                </div>
            </div>
        </main>
